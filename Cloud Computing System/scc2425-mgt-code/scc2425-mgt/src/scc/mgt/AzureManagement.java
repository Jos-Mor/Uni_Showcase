...
public class AzureManagement {
	// Configuration flags to control resource creation
	...
	// Student ID suffix for resource naming
	...
	static final String[] BLOB_CONTAINERS = { "shorts" };	// Blob storage containers

	static final Region[] REGIONS = new Region[] { Region.EUROPE_NORTH, Region.EUROPE_NORTH}; // Define the regions to deploy resources here
	...
	// Application name must match the configuration in pom.xml
				...
				if (CREATE_COSMOSDB) {
					Thread th = new Thread(() -> {
						try {
							...
							// Create the required collections for the application
